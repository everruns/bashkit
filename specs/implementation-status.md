...
| Grep | 95 | Yes | 95 | 0 | -z, -r, -a, -b, -H, -h, -f, -P, --include, --exclude, binary detect; rg has context, glob, -e, -o, -q, filename controls, help/version, indexed recursive search, and pinned real-rg differentials |
