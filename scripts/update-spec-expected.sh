...
# cargo test --test integration -- spec_tests:: --ignored
...
if $VERBOSE; then
    cargo test --test integration -- spec_tests:: --ignored --nocapture 2>&1
else
    cargo test --test integration -- spec_tests:: --ignored 2>&1
fi
