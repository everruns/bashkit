...
_NAMES = (
    ...
    "test_bash_shell_state_exposes_read_only_state_and_restore_roundtrip",
    "test_bash_restore_shell_state_rejects_missing_cwd_after_reset",
    ...
    "test_bashtool_shell_state_exposes_read_only_state_and_restore_roundtrip",
    "test_bashtool_restore_shell_state_rejects_missing_cwd_on_fresh_instance",
