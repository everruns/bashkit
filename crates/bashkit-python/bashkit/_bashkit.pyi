...
class FileSystem:
    """Direct access to BashKit's virtual filesystem."""
...
class Bash:
    ...
    def mount_text(self, path: str, content: str) -> None: ...
    def mount_readonly_text(self, path: str, content: str) -> None: ...
    def mount_real_readonly(self, host_path: str) -> None: ...
    def mount_real_readonly_at(self, host_path: str, vfs_mount: str) -> None: ...
    def mount_real_readwrite(self, host_path: str) -> None: ...
    def mount_real_readwrite_at(self, host_path: str, vfs_mount: str) -> None: ...
