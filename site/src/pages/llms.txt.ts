...
export const GET: APIRoute = () => {
  ...
  const text = [
    ...
    "",
    "Each link below points at the Markdown representation of the page so it can",
    "be fetched and read directly. For the full text of every guide inlined into",
    "one document, fetch /llms-full.txt.",
    "",
    "## Quickstarts",
    "",
    ...languages.map(
