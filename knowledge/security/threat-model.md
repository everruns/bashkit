...
| TM-DOS-106 | Deep Agents direct VFS traversal/result amplification | Dense matching files or broad recursive searches bypass shell execution limits and amplify into host objects | Mandatory grep count/byte caps; streaming lines; shared deadline, cancellation, traversal, and session-work budgets | **MITIGATED** |
